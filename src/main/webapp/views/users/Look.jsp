...
<head>
    ...
    <link href="../../css/users/Look.css" rel="stylesheet"/>
...
<div class="home-page">
    ...
    <!--content-->
    <div class="banner-center" style="margin-top:30px;">
        <div class="container">
            <div class="col-md-5 block bb-left">
                <a href="detail-goods.jsp">
                    <div class="bb-left-inner">
                        <h3>钥匙</h3>
                    </div>
                </a>
            </div>
            <div class="col-md-4 block bb-middle">
                <a href="#">
            ...
            <div class="col-md-3 block bb-right">
                <a href="#">
            ...
            <div class="col-md-12 block bb-bottom">
                <a href="#">
                    <div class="bb-bottom-inner">
                        <h3>其他</h3>
                    </div>
                </a>
            </div>
