        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="Root.jsp"><i class="fa fa-user-circle-o"></i>用户管理</a>
                    </li>
					<li>
                      <a href="#"><i class="fa fa-cubes"></i>发布信息管理<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="Lost.jsp"><i class="fa fa-tag"></i>丢失信息</a>
                            </li>
                            <li>
                                <a href="pickUp.jsp"><i class="fa fa-tag"></i>拾回信息</a>
                            </li>
						</ul>
					</li>
                    <li>
                        <a href="#"><i class="fa fa-cubes"></i>发布信息<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="Lost.jsp"><i class="fa fa-tag"></i>丢失信息</a>
                            </li>
                    ...
                    <li>
                        <a href="Dynamic.html"><i class="fa fa-pencil-square-o"></i>物品类别管理</a>
                    </li>
                </ul>
            </div>
        </nav>
...
<!--修改密码模态框-->
    ...
    <script src="../../js/root/jquery.metisMenu.js" type="text/javascript"></script>
    <script src="../../js/root/custom-scripts.js" type="text/javascript"></script>
